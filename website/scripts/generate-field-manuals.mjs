  ...
  return `<header class="site-header">
      <nav class="nav" aria-label="Principal">
        ...
        <div class="nav-links">
          ...
          <span class="nav-menu"><button${parentAttr(["start", "universe", "archetypes", "enemies", "battlefields", "prophecy"])} type="button" aria-haspopup="true">Explorar <span class="nav-caret" aria-hidden="true">▼</span></button><span class="submenu"><a${activeAttr("start")} href="/start-here/">Empieza Aquí</a><a${activeAttr("universe")} href="/the-watchman-universe/">The Watchman Universe</a><a href="/archetypes/">Arquetipos</a><a href="/enemy-forces/">Fuerzas de Corrupción</a><a href="/battlefields/">Biblioteca de Batallas</a><a href="/prophecy/">Mapa Profético</a></span></span>
